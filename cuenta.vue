        ...
        <div>
            <div>
                <div class="account-header">
                    <h3><span class="ti-bolt"></span></h3>
                    <small>Comida y Bebidas Increibles</small>
                </div>

                <div class="account-tabs">
                    <button :class="isActive === 0? 'is-active': ''" @click="isActive = 0">Iniciar Sesion</button>
                    <button :class="isActive === 1? 'is-active': ''" @click="isActive = 1">Registrate</button>
                </div>
